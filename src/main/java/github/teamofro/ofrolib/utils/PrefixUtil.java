...
public class PrefixUtil {
	...
	public final Component loggerPrefix;
	...
	public final void logInfo(Object message) {
		log(loggerPrefix.append(Util.mm(message)), isInfoEnabled());
	}
	...
	public final void send(CommandSender sender, Object str) {
		if (sender != null && isSendEnabled()) {
			sender.sendMessage(prefix.append(Util.mm(str)));
		}
	}
	...
	public final void Cast(String str) {
		if (isCastEnabled()) {
			Bukkit.broadcast(prefix.append(Util.mm(str)));
		}
	}
