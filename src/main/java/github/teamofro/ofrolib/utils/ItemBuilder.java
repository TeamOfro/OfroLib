...
public class ItemBuilder {
	...
	public ItemBuilder attributes(Multimap<Attribute, AttributeModifier> attributeModifiers) {
		return changeItemMeta(
				meta -> meta.setAttributeModifiers(attributeModifiers));
	}
	...
	public ItemBuilder addAttribute(Attribute attribute,
		...
		return changeItemMeta(
				meta -> meta.addAttributeModifier(attribute, attributeModifier));
	}
	...
	public ItemBuilder addAttributes(Multimap<Attribute, AttributeModifier> attributeModifiers) {
		return attributeModifiers.entries().stream().reduce(
				this,
	 ...
	 */
	public <T, Z> ItemBuilder persistentData(NamespacedKey key,
	...
	/**
	 * byte[] で {@link #persistentData(NamespacedKey, PersistentDataType,
	 * Object)} を設定します
	 *
	 * @param key   値のキー
	 * @param value 値
	...
	/**
	 * double で {@link #persistentData(NamespacedKey, PersistentDataType,
	 * Object)} を設定します
	 *
	 * @param key   値のキー
	 * @param value 値
	...
	/**
	 * long[] で {@link #persistentData(NamespacedKey, PersistentDataType,
	 * Object)} を設定します
	 *
	 * @param key   値のキー
	 * @param value 値
	...
	/**
	 * string で {@link #persistentData(NamespacedKey, PersistentDataType,
	 * Object)} を設定します
	 *
	 * @param key   値のキー
	 * @param value 値
	...
	/**
	 * {@link PersistentDataContainer} で {@link #persistentData(NamespacedKey,
	 * PersistentDataType, Object)} を設定します
	 *
	 * @param key   値のキー
	 * @param value 値
	 * @return new instance (use {@link #build()} to create)
	 */
	public ItemBuilder persistentData(NamespacedKey key,
			PersistentDataContainer value) {
	...
	/**
	 * {@link #createSkull(String)}
	 * のように先にItemMetaのキャストをしたいときに使用してください
	 *
	 * @param consumer 実行する処理
	 * @return new instance (use {@link #build()} to create)
