...
import github.teamofro.ofrolib.utils.ItemBuilder;
...
public class Items {
	...
	private static final ItemBuilder thousandYen = new ItemBuilder(Material.IRON_NUGGET)
			.name(Util.component(
					"&4&l&ko&r&c&l御風呂コイン - レッドストーン&4&l&ko&r"))
			.lore(Util.component("&d1000円の価値があるコイン。"),
					Util.component("&dサーバー内で1000円として使用できる。"))
			.customModelData(4)
			.glow();

	private static final ItemBuilder tenThousandYen = new ItemBuilder(Material.IRON_NUGGET)
			.name(Util.component(
					"&1&l&ko&r&b&l御風呂コイン - ダイヤモンド&1&l&ko&r"))
	...
	public static boolean isMoneyItem(ItemStack itemStack) {
		return itemStack.getType().equals(Material.IRON_NUGGET) &&
				itemStack.getItemMeta().hasCustomModelData() &&
				itemStack.getItemMeta().getCustomModelData() < 6;
	}
